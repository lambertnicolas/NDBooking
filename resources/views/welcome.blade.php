...
<form>
    <div class="form-group">
        ...
        <input class="input is-link" type="text" id="name" placeholder="Name">
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Phone</label>
        <input class="input is-link" type="text" id="phone" placeholder="Phone">
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Email</label>
        <input class="input is-link" type="text" id="email" placeholder="Email">
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Table</label>
        <input class="input is-link" type="text" id="table" placeholder="Table number">
    </div>
